...
describe('RetroReceiver', () => {
  ...
  describe('withdrawETH(address)', () => {
    describe('when called by the owner', () => {
      it('should withdraw all ETH in the contract', async () => {
        ...
        await RetroReceiver['withdrawETH(address)'](DEFAULT_RECIPIENT)
  ...
  describe('withdrawETH(address,uint256)', () => {
    describe('when called by the owner', () => {
      it('should withdraw the given amount of ETH', async () => {
        ...
        await RetroReceiver['withdrawETH(address,uint256)'](
          DEFAULT_RECIPIENT,
          DEFAULT_AMOUNT
        )
  ...
  describe('withdrawERC20(address,address)', () => {
    describe('when called by the owner', () => {
      it('should withdraw all ERC20 balance held by the contract', async () => {
        ...
        await RetroReceiver['withdrawERC20(address,address)'](
          TestERC20.address,
          DEFAULT_RECIPIENT
        )
  ...
  describe('withdrawERC20(address,address,uint256)', () => {
    describe('when called by the owner', () => {
      it('should withdraw the given ERC20 amount', async () => {
        ...
        await RetroReceiver['withdrawERC20(address,address,uint256)'](
          TestERC20.address,
          DEFAULT_RECIPIENT,
          DEFAULT_AMOUNT
        )
  ...
  describe('withdrawERC721', () => {
    describe('when called by the owner', () => {
      it('should withdraw the the token', async () => {
        ...
        await RetroReceiver.withdrawERC721(
          TestERC721.address,
          DEFAULT_RECIPIENT,
          DEFAULT_TOKEN_ID
        )
